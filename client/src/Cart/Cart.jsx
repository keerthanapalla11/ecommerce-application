...
export default function Cart() {
    ...
    async function fetchCartProducts() {
        await axios.get("https://ecommerce-application-0tt5.onrender.com/api/cart", {
    ...
    async function removeFromCart(productId){
        try{
            await axios.delete(`https://ecommerce-application-0tt5.onrender.com/api/cart/remove/${productId}`,{
                headers:{Authorization:`Bearer ${user.token}`}
            })
            .then((res)=>{
